    ...
    $node.html([
        ...
        (options.title
            ? '    <div class="modal-header">' +
                ...
                '      <h4 class="modal-title pull-right">' + options.title + '</h4>' +
                '    </div>' : ''),
...
var ui = {
    ...
    button: function ($node, options) {
        return renderer.create('<button type="button" class="note-btn btn btn-dark btn-sm" tabindex="-1">', function ($node, options) {
